(ns im.ttalk.agent.prompt.api
  "提示词模板 API - 统一入口
   ...
   (require '[im.ttalk.agent.prompt.api :as prompt])
  ...
  (:require [im.ttalk.agent.prompt.protocol :as proto]
            [im.ttalk.agent.prompt.template :as tpl]
            [im.ttalk.agent.prompt.chat :as chat]
            [im.ttalk.agent.prompt.selector :as sel]))
