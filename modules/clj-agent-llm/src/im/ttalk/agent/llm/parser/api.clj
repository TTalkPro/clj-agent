(ns im.ttalk.agent.llm.parser.api
  "输出解析器 API - 统一入口
   ...
   (require '[im.ttalk.agent.llm.parser.api :as parser])
  ...
  (:require [im.ttalk.agent.llm.parser.protocol :as proto]
            [im.ttalk.agent.llm.parser.json :as json-impl]
            [im.ttalk.agent.llm.parser.json-schema :as js]
            [im.ttalk.agent.llm.parser.retry :as retry-impl]))
