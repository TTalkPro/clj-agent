(ns im.ttalk.agent.model.provider.base
  ...
  (:require [clojure.string :as str]
            [im.ttalk.agent.model.provider :as proto]
            [im.ttalk.agent.model.schema.openai :as schema]
            [im.ttalk.agent.model.response.parser :as parser]
            [im.ttalk.agent.model.provider.openai-compat :as compat]))
