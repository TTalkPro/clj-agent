(ns im.ttalk.agent.model.provider.openai-compat
  "OpenAI 兼容 API 调用
   ...
   (require '[im.ttalk.agent.model.provider.openai-compat :as compat])
  ...
  (:require [im.ttalk.agent.model.http.client :as http]
            [im.ttalk.agent.model.schema.openai :as schema]
            [im.ttalk.agent.model.stream.openai :as stream]))
