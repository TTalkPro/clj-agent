(ns im.ttalk.agent.model.chat
  "LLM Chat Service 工厂
   ...
   (require '[im.ttalk.agent.model.chat :as chat])
  ...
  (:require [im.ttalk.agent.model.service :as service]
            ...
            [im.ttalk.agent.model.wire.openai :as wire-openai]
            [im.ttalk.agent.model.wire.anthropic :as wire-anthropic]))
...
(defn create-service
  ...
  (let [llm-provider (or provider
                         (let [create-fn (requiring-resolve
                                           'im.ttalk.agent.model.provider.anthropic/create-provider)]
                           (create-fn (cond-> {}
