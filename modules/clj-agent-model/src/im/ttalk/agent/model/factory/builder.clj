(ns im.ttalk.agent.model.factory.builder
  ...
  (:require [im.ttalk.agent.model.factory.registry :as registry]
            [im.ttalk.agent.model.factory.config :as config]
...
(defn- ensure-providers-registered!
  ...
  (when (empty? (registry/get-providers))
    (require '[im.ttalk.agent.model.provider.anthropic]
             '[im.ttalk.agent.model.provider.openai]
             '[im.ttalk.agent.model.provider.zhipu]
             '[im.ttalk.agent.model.provider.mock]
             '[im.ttalk.agent.model.provider.ollama]
             '[im.ttalk.agent.model.provider.gemini]
             '[im.ttalk.agent.model.provider.mistral])
    (registry/register-provider! :anthropic (resolve 'im.ttalk.agent.model.provider.anthropic/create-provider))
    (registry/register-provider! :openai    (resolve 'im.ttalk.agent.model.provider.openai/create-provider))
    (registry/register-provider! :zhipu     (resolve 'im.ttalk.agent.model.provider.zhipu/create-provider))
    (registry/register-provider! :mock      (resolve 'im.ttalk.agent.model.provider.mock/create-mock-provider))
    (registry/register-provider! :ollama    (resolve 'im.ttalk.agent.model.provider.ollama/create-provider))
    (registry/register-provider! :gemini    (resolve 'im.ttalk.agent.model.provider.gemini/create-provider))
    (registry/register-provider! :mistral   (resolve 'im.ttalk.agent.model.provider.mistral/create-provider))))
